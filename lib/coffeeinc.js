...
function generateNewInv(){
  ...
  avEquity=parseInt(avEquity)/investorInformation.length;
  avOffer=parseInt(avOffer)/investorInformation.length;
  ...
  randomInvOffer1=Math.round((avOffer+inc)*(randomInvEquity1/avEquity)*(budget/fixedCost));
  
  randomInvOffer2=Math.floor((($.totalStorage.getItem("stat_talent")/2)+(5*($.totalStorage.getItem("stat_sat")+10)/2))*(Math.random()+0.5));
  randomInvEquity2=Math.floor(((parseInt($.totalStorage.getItem("fixedCost"))/2)+(randomInvOffer2/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
  
  randomInvOffer3=Math.floor((($.totalStorage.getItem("stat_talent")/2)+(5*($.totalStorage.getItem("stat_sat")+10)/2))*(Math.random()+0.5));
  randomInvEquity3=Math.floor(((parseInt($.totalStorage.getItem("fixedCost"))/2)+(randomInvOffer3/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
  
  randomInvOffer4=Math.floor((($.totalStorage.getItem("stat_talent")/2)+(5*($.totalStorage.getItem("stat_sat")+10)/2))*(Math.random()+0.5));
  randomInvEquity4=Math.floor(((parseInt($.totalStorage.getItem("fixedCost"))/2)+(randomInvOffer4/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
