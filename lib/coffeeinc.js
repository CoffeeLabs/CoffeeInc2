...
function generateNewEmp(){
  ...
  randomSalary1=Math.floor(((parseInt($.totalStorage.getItem("avSalary"))/2)+(randomSkill1/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
  ...
  randomSalary2=Math.floor(((parseInt($.totalStorage.getItem("avSalary"))/2)+(randomSkill2/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
  ...
  randomSalary3=Math.floor(((parseInt($.totalStorage.getItem("avSalary"))/2)+(randomSkill3/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
  ...
  randomSalary4=Math.floor(((parseInt($.totalStorage.getItem("avSalary"))/2)+(randomSkill4/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
