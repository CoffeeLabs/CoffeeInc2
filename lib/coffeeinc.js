...
function generateNewEmp(){
  ...
  document.getElementById("newEmpempHiringPicId1").value=empHiringPicId1;
  document.getElementById("newEmpempHiringPicId2").value=empHiringPicId2;
  document.getElementById("newEmpempHiringPicId3").value=empHiringPicId3;
  document.getElementById("newEmpempHiringPicId4").value=empHiringPicId4;
