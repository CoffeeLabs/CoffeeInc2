  ...
  if(employeeInformation.length<=10){
    for(var i = 0; i < employeeInformation.length; i++){
      if(employeeInformation[i][0]!=0){
        ...
        if(i<9){
          document.getElementById("empPic"+i).setAttribute("src","/CoffeeInc2/assets/add.svg");
          document.getElementById("empPic"+i).className="add_button";
...
function paintInvField(){
  for(var x=0; x<9; x++){
    ...
    document.getElementById("inv"+x).onclick="javascript:changeInvProfileInfo("+x+");";
  }
  if(investorInformation.length<=10){
    for(var i = 0; i < investorInformation.length; i++){
      if(investorInformation[i][0]!=0){
        ...
        if(i<9){
          document.getElementById("invPic"+i).setAttribute("src", "/CoffeeInc2/assets/add.svg");
...
function generateNewEmp(){
  ...
  if(randomEmpHiringSalary1>1500)
    randomEmpHiringSalary1=1500;
  if(randomEmpHiringSalary2>1500)
    randomEmpHiringSalary2=1500;
  if(randomEmpHiringSalary3>1500)
    randomEmpHiringSalary3=1500;
  if(randomEmpHiringSalary4>1500)
    randomEmpHiringSalary4=1500;
...
function generateNewInv(){
  var avSkill=$.totalStorage.getItem("stat_talent");
  var productscore=$.totalStorage.getItem("stat_product");
  if(avSkill==0){
    productscore=1;
    avSkill=1;
  }
  
  randomInvEquity1=Math.round((($.totalStorage.getItem("stat_equity")-(100-$.totalStorage.getItem("stat_equity")))/2-1)*Math.random())+1;
  randomInvOffer1=Math.round((productscore/2+avSkill/2)*50*Math.random()*0.8+0.2)+100;
  ////Math.round((Math.pow(avSkill,2)/Math.sqrt(fixedCost))*Math.pow(randomInvEquity1,2));
  //parseInt(1000)+parseInt(Math.round(22000*fixedCost/budget))+parseInt(Math.round(22000*randomInvEquity1/myEquity));
  //Math.round((avOffer+(1*inc))*(parseInt(randomInvEquity1)/parseInt(avEquity))/14);
  //*(budget/fixedCost));
  
  randomInvEquity2=Math.round((($.totalStorage.getItem("stat_equity")-(100-$.totalStorage.getItem("stat_equity")))/2-1)*Math.random())+1;
  randomInvOffer2=Math.round((productscore/2+avSkill/2)*50*Math.random()*0.8+0.2)+100;
  //Math.round((Math.pow(avSkill,2)/Math.sqrt(fixedCost))*Math.pow(randomInvEquity2,2));
  //parseInt(1000)+parseInt(Math.round(22000*fixedCost/budget))+parseInt(Math.round(22000*randomInvEquity2/myEquity));
  //Math.round((avOffer+(2*inc))*(randomInvEquity2/avEquity)/14);
  //*(budget/fixedCost));
  
  randomInvEquity3=Math.round((($.totalStorage.getItem("stat_equity")-(100-$.totalStorage.getItem("stat_equity")))/2-1)*Math.random())+1;
  randomInvOffer3=Math.round((productscore/2+avSkill/2)*50*Math.random()*0.8+0.2)+100;
  //Math.round((Math.pow(avSkill,2)/Math.sqrt(fixedCost))*Math.pow(randomInvEquity3,2));
  //parseInt(1000)+parseInt(Math.round(22000*fixedCost/budget))+parseInt(Math.round(22000*randomInvEquity3/myEquity));
  //Math.round((avOffer+(3*inc))*(randomInvEquity3/avEquity)/14);
  //*(budget/fixedCost));
  
  randomInvEquity4=Math.round((($.totalStorage.getItem("stat_equity")-(100-$.totalStorage.getItem("stat_equity")))/2-1)*Math.random())+1;
  randomInvOffer4=Math.round((productscore/2+avSkill/2)*50*Math.random()*0.8+0.2)+100;
  //Math.round((Math.pow(avSkill,2)/Math.sqrt(fixedCost))*Math.pow(randomInvEquity4,2));
  //parseInt(1000)+parseInt(Math.round(22000*fixedCost/budget))+parseInt(Math.round(22000*randomInvEquity4/myEquity));
  //Math.round((avOffer+(4*inc))*(randomInvEquity4/avEquity)/14);
  //*(budget/fixedCost));
...
function changeInvProfileInfo (pos) {
  if(investorInformation.length>1){
    ...
    if(empPicId!=0){
      ...
      if(invOffer<200)
        add=2;
      Lungo.Element.progress("#invProgressProfileOffer",Math.round((invOffer)/50)+parseInt(add),false);
