...
function generateNewEmp(){
  ...
  document.getElementById("newEmpHiringPicId1").value=empHiringPicId1;
  document.getElementById("newEmpHiringPicId2").value=empHiringPicId2;
  document.getElementById("newEmpHiringPicId3").value=empHiringPicId3;
  document.getElementById("newEmpHiringPicId4").value=empHiringPicId4;
