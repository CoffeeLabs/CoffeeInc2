...
function generateNewInv(){
  ...
  randomInvEquity1=Math.floor(((parseInt($.totalStorage.getItem("fixedCost"))/2)+(randomInvOffer1/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2))*(Math.random()+0.5));
