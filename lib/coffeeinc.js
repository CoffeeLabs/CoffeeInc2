...
function changeEmpProfileInfo (pos) {
  ...
  if(empPicId!=0){
    ...
    Lungo.Element.progress("#empProgressProfileSalary",Math.round(empSalary/25),false);
...
function hireInvestor(Pic,Name,Equity,Offer){
  ...
  investorInformation.push([Pic,Name,Equity,Offer,$.totalStorage.getItem("counter")]);
