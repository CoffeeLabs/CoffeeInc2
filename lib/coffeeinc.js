...
function incSalary(){
  ...
  if(parseInt(empSalary)>2500){
    ...
    $.totalStorage.setItem("avSalary",$.totalStorage.getItem("avSalary")+parseInt(31));
  var y=100-empSat;
  incsat=parseInt(Math.log(parseInt((2500-parseInt(empSalary)+parseInt(employeeInformation[currentEmpPosition][5]))))/Math.log(parseInt(2500)))*parseInt(Math.log(parseInt(y))/Math.log(parseInt(100)));//Math.round(x*Math.random()*0.2+1));
  alert(Math.log(empSat)/Math.log(2500));
  //empSat=parseInt(empSat)+parseInt(incsat);
  
  //=Math.floor(Math.log(empSat)/Math.log(100))+Math.floor(Math.log(empSalary+1)/Math.log(2501)*50);
...
function hireInvestor(Pic,Name,Equity,Offer){
  ...
  investorInformation.push([Pic,Name,Equity,Offer]);
  ...
  investorInformation.push([0,0,0,0]);
