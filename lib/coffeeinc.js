...
function paintEmpField(){
  for(var x=0; x<9; x++){
    ...
    document.getElementById("empPic"+x).className="add add_button";
    document.getElementById("emp"+x).href="#employee_hire";
  }
  if(employeeInformation.length<=9){
...
function paintInvField(){
  for(var x=0; x<9; x++){
    ...
    document.getElementById("invPic"+x).className="add add_button";
    document.getElementById("inv"+x).href="#investment";
  }
  if(investorInformation.length<=9){
...
function generateNewEmp(){
  ...
  randomEmpHiringSalary1=parseInt(50)+Math.round((parseInt(notNull($.totalStorage.getItem("avSalary")))/2+randomEmpHiringSkill3/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2)*(Math.random()+0.5));
  ...
  randomEmpHiringSalary2=parseInt(50)+Math.round((parseInt(notNull($.totalStorage.getItem("avSalary")))/2+randomEmpHiringSkill3/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2)*(Math.random()+0.5));
  ...
  randomEmpHiringSalary3=parseInt(50)+Math.round((parseInt(notNull($.totalStorage.getItem("avSalary")))/2+randomEmpHiringSkill3/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2)*(Math.random()+0.5));
  ...
  randomEmpHiringSalary4=parseInt(50)+Math.round((parseInt(notNull($.totalStorage.getItem("avSalary")))/2+randomEmpHiringSkill3/parseInt(notNull($.totalStorage.getItem("stat_talent")))/2)*(Math.random()+0.5));
...
function changeEmpProfileInfo (pos) {
  ...
  if(empPicId!=0){
    ...
    Lungo.dom("#empProfileName").attr("data-title",empName);
    ...
    if(empSkill<2)
      add=2;
    Lungo.Element.progress("#empProgressProfileSkill",empSkill+add,true);
    add=0;
    if(empSat<2)
      add=2;
...
function changeInvProfileInfo (pos) {
  ...
  if(empPicId!=0){
    ...
    Lungo.dom("#invProfileName").attr("data-title",invName);
    document.getElementById('invProfileEquity').innerHTML="Equity: "+invEquity+"%";
    document.getElementById('invProfileOffer').innerHTML="Offer: "+invOffer;

    Lungo.Element.progress("#invProgressProfileEquity",invEquity,false);
    Lungo.Element.progress("#invProgressProfileOffer",Math.round(invOffer/100),false);
...
function decSalary(){
  ...
  if(parseInt(empSalary)<0){
    ...
    $.totalStorage.setItem("avSalary",$.totalStorage.getItem("avSalary")-parseInt(minus));
...
function incSalary(){
  ...
  if(parseInt(empSalary)>2500){
    ...
    $.totalStorage.setItem("avSalary",$.totalStorage.getItem("avSalary")+parseInt(plus));
  employeeInformation[currentEmpPosition][6]=empSalary;
  employeeInformation[currentEmpPosition][4]=empSat;
  $.totalStorage.setItem("emp", employeeInformation);
  document.getElementById('empProfileSat').innerHTML="Satisfaction: "+empSat;
...
function hireInvestor(Pic,Name,Equity,Offer){
  ...
  investorInformation.push([Pic,Name,Equity,Offer,$.totalStorage.getItem("counter"),Math.random()*10]);
  $.totalStorage.setItem("stat_budget", $.totalStorage.getItem("stat_budget")+parseInt(Offer));
  $.totalStorage.setItem("stat_equity", $.totalStorage.getItem("stat_equity")-Equity);
