...
//        alert(rand*(employeeInformation[emp][4]/100));
    ...
    invint=Math.floor(((parseInt(product)+parseInt(talent)+parseInt(satisfaction))/3)*parseInt(5/6)+parseInt(1/6)*(budget/notNull($.totalStorage.getItem("stat_old_budget"))));
